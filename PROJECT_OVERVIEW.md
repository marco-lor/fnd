...
Notes:
- CORS origins configured: `https://fatin-test.web.app`, `https://fatin-test.firebaseapp.com/` (trailing slash), `http://localhost:3000`. Consider removing trailing slash for consistency.
