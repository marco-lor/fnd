...
export function AddAccessorioOverlay({ onClose, showMessage, initialData = null, editMode = false, inventoryEditMode = false, inventoryUserId = null, inventoryItemId = null, inventoryItemIndex = null }) {
    ...
    const configuration = useEditorConfiguration('schema_accessorio');
    ...
    const { change: handleNestedChange, changeParameter: handleParameterChange } = useEditorFormActions(setAccessorioFormData);
    ...
    const renderBasicFields = () => {
        ...
        return (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                <EditorParameterTable title="Parametri Speciali" schemaCategory={schema.Parametri.Special} paramCategory="Special" values={accessorioFormData.Parametri?.Special} userParams={userParams} onChange={handleParameterChange} sorted />
                <EditorParameterTable title="Parametri Base" schemaCategory={schema.Parametri.Base} paramCategory="Base" values={accessorioFormData.Parametri?.Base} userParams={userParams} onChange={handleParameterChange} sorted />
                <EditorParameterTable title="Parametri Combattimento" schemaCategory={schema.Parametri.Combattimento} paramCategory="Combattimento" values={accessorioFormData.Parametri?.Combattimento} userParams={userParams} onChange={handleParameterChange} sorted />
            </div>
        );
    };
