...
function LoginSubmitButton({ disabled = false, isLoggingIn }) {
  const [isHovered, setIsHovered] = useState(false);
  const isDisabled = disabled || isLoggingIn;

  return (
    <PerformanceProfiler id="LoginSubmitButton">
...
export default React.memo(LoginSubmitButton);
