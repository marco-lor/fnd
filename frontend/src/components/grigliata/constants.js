...
export const MIN_GRIGLIATA_TOKEN_SIZE_SQUARES = 1;
export const MAX_GRIGLIATA_TOKEN_SIZE_SQUARES = 9;
export const BOARD_FIT_PADDING = 48;
export const MIN_GRIGLIATA_VIEWPORT_SCALE = 0.05;
export const MAX_GRIGLIATA_VIEWPORT_SCALE = 4;
export const MAX_GRIGLIATA_FIT_VIEWPORT_SCALE = 2.5;
